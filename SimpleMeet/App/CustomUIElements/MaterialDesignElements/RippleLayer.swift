...
class RippleLayer: CALayer, CAAnimationDelegate {
    ...
    var elevationOffset: CGSize = CGSize.zero {
        didSet {
            self.enableElevation()
        }
    }
    ...
    func setRippleColor(color: UIColor, withRippleAlpha rippleAlpha: CGFloat = 0.3, withBackgroundAlpha backgroundAlpha: CGFloat = 0.3) {
        if let rippleLayer = self.rippleLayer, let backgroundLayer = self.backgroundLayer {
